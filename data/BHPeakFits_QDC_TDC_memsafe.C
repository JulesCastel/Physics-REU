// BHPeakFits_QDC_TDC_memsafe.C
//
// Memory-safer ROOT macro for Gaussian peak fits in BH QDC/TDC histograms.
//
...
//   root -l -b -q 'BHPeakFits_QDC_TDC_memsafe.C(".", "BH_peak_output_35566", 35566, 35566)'
//
// Usage, one run CSV only, no plots:
//   root -l -b -q 'BHPeakFits_QDC_TDC_memsafe.C(".", "BH_peak_csv_35566", 35566, 35566, false)'
//
...
//   root -l -b -q 'BHPeakFits_QDC_TDC_memsafe.C(".", "BH_peak_recursive_35566", 35566, 35566, false, true)'
                               ...
                               bool allowRecursiveSearch)
{
    ...
    TString histName = BuildHistNameMemSafe(plane, paddle, type);
    TString paddleTag = Form("%s%02d", plane.Data(), paddle);
